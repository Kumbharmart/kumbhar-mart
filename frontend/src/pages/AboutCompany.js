...
const AboutCompany = () => {
  return (
    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap items-center">
      <img alt="Ask a Question" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="/about.svg" />
        ...
        <div class="text-center lg:text-left">
          ...
          <div class="flex mb-4">
                <span class="flex items-center">
                  ...
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-sky-600" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                  </svg>
